...
var result = document.querySelector("#likedpokemons");
...
pokemons = pokemons.slice(0,20);    
 ...
 for (const toy of pokemons) {
     ...
     card.setAttribute("class"," pokemon__list-item card col-3 m-5");

     var cardImage = document.createElement("img");
     cardImage.setAttribute("class", "card__image");
     cardImage.src = toy.img;

     var cardTitle = document.createElement("h4");
     cardTitle.classList.add( "card__title");
     var cardTitleStrong = document.createElement("strong");
     cardTitleStrong.textContent = toy.name;

     var cardP = document.createElement("p");
     cardP.classList.add( "card__text");
     cardP.textContent = toy.type;

     var cardButtons = document.createElement("div");
     cardButtons.setAttribute("class", "card__buttons");
     ...
     cardLikeImg.classList.add( "card__buttons-img");

     cardButtons.appendChild(cardLikeImg);
 ...
 var  likedpokemons = document.getElementById('likedpokemons');
